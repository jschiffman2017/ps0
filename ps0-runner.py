...
print("{} is {}.".format(number, oddEven))
number = 2
oddEven = ps0.oddOrEven(number)
print("{} is {}.".format(number, oddEven))
...
print("{} is {}.".format(number, perfect))
number = 1
perfect = ps0.perfectNumber(number)
print("{} is {}.".format(number, perfect))
number = 6
...
print("{} is {} by the sum of its digits.".format(number, sumDivisible))
number = 1
sumDivisible = ps0.sumDigitsDivisible(number)
print("{} is {} by the sum of its digits.".format(number, sumDivisible))
number = 12
...
print("{} is {} by {}.".format(number, divisible, divisor))
divisor = 2
divisible = ps0.divisibleBy(number, divisor)
print("{} is {} by {}.".format(number, divisible, divisor))
number = 4
